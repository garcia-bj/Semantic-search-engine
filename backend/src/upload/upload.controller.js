...
var UploadController = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.uploadService.uploadOwlDocument(file)];
                        case 2:
                            document_1 = _a.sent();
                            return [2 /*return*/, {
                        ...
                        case 3:
                            error_1 = _a.sent();
                            throw new common_1.HttpException(error_1.message || 'Failed to process file', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
                        case 4: return [2 /*return*/];
                    }
                });
            });
        };
        UploadController_1.prototype.getDocuments = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.uploadService.getDocuments()];
                });
            });
        };
        UploadController_1.prototype.deleteDocument = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.uploadService.deleteDocument(id)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, { message: 'Document deleted successfully' }];
                        case 2:
                            error_2 = _a.sent();
                            throw new common_1.HttpException(error_2.message || 'Failed to delete document', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    (function () {
        ...
        _getDocuments_decorators = [(0, common_1.Get)('documents')];
        _deleteDocument_decorators = [(0, common_1.Delete)('documents/:id')];
